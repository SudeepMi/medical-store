@extends('layouts.app')
@section('title','Create Threshold')
@section('content')
<form class="kt-form add-threshold-form" id="kt_form " method="POST" action="{{route('membership.threshold.store')}}" autocomplete="off">
    @csrf
    <div class="row">
        <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 ">
                                                <div class="row thresholds">
                                                    @if(old('threshold'))
                                                        @foreach(old('threshold') as $uuid=>$threshold)
                                                            <div class="threshold">
                                                                <div class="form-group">
                                                                @if ($loop->first)
