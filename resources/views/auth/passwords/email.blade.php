					...
					<div class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper">
						...
						<div class="kt-login__body">
							<div class="kt-login__form">
                                ...
                                @endif		
                                <form class="kt-form" method="POST" action="{{ route('password.email') }}" novalidate="novalidate">
                                        @csrf
                                    <div class="form-group">
										<input class="form-control @error('email') is-invalid @enderror" type="text" placeholder="Email" name="email" value="{{old('username')}}" autocomplete="off">
										@error('email')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
									...
									<div class="kt-login__actions">
										@if (Route::has('welcome'))
											<a class="kt-link kt-login__link-forgot" href="{{ route('welcome') }}">
												{{ __(' Login') }}
											</a>
										@endif
