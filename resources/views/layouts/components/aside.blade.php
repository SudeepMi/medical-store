                                ...
                                <ul class="kt-menu__nav ">
                                    <li class="kt-menu__item " aria-haspopup="true">
                                        <a href="#" class="kt-menu__link ">
                                            ...
                                            <span class="kt-menu__link-text">TRUFFLE SOFTWARE</span>
                                        </a>
                                    </li>
                                    <li class="kt-menu__section ">
                                        <h4 class="kt-menu__section-text">Menu Header 1</h4>
                                    ...
                                    <li class="kt-menu__item " aria-haspopup="true">
                                        <a href="/getingstarted" class="kt-menu__link ">
                                            <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                    ...
                                    <li class="kt-menu__item " aria-haspopup="true">
                                        <a href="{{ route ('log.recent') }}" class="kt-menu__link ">
                                            <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
